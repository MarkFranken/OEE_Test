...
- Ondersteunt 2 typen bestanden:
  - **Order XML** (`*.xml`, gematcht op jobnaam)
...
- Lege reasons uit timeline-regels met `Uptime` worden niet als downtime-reden meegenomen in overzichten en job-dwarsdoorsnede.
